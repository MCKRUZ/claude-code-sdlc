...
6. **BLOCKING HITL GATE — Surface and resolve open questions before ANY new-phase work:**

   This gate is **MANDATORY** and **BLOCKING**. You MUST complete it before proceeding to step 7 or writing any artifacts for the new phase. There are NO exceptions.
   ...
   **Procedure:**
   ...
   5. **WAIT for the user to respond.** Do NOT continue to step 7. Do NOT begin writing any artifacts. Do NOT summarize next steps as if work can begin.
   ...
   7. Only after EVERY open question has a confirmed resolution may you proceed to step 7.

   **If there are no open questions** in the handoff document, explicitly state: "No open questions found in the handoff. Proceeding to phase guidance." Then continue to step 7.
...
7. **Show next phase guidance:** After advancing AND after the HITL gate in step 6 is fully resolved, display:
   ...
   **Reminder: Do NOT begin writing any of these artifacts until the HITL gate (step 6) is fully resolved.** If you skipped step 6 or the user has not confirmed answers to all open questions, STOP and go back to step 6 now.
...
- The HITL gate in step 6 is **non-negotiable**. Open questions MUST be surfaced with proposed defaults and resolved with user confirmation before any new-phase artifact work begins.
